...
void initialize(void)
{
  ...
  LATBbits.LATB3 = 1;		// initialize the pin voltage level
  ...
  // Initialize "1-2EN" PWM control output (RA4)

  //TRISAbits.TRISA4 = 0;    // Make RB11 digital O/P
  //LATAbits.LATA4 = 0;		// initialize the pin voltage level

  // Initialize "1A" control output (RB9)

  TRISBbits.TRISB9 = 0;    // Make RB9 digital O/P
  LATBbits.LATB9 = 0;		// initialize the pin voltage level

  // Initialize "2A" control output (RA7)

  TRISAbits.TRISA7= 0;    // Make RA7 digital O/P
  LATAbits.LATA7 = 1;		// initialize the pin voltage level
  ///////////////////////
  ////////////////////////
  //////////////////////////
...
void get_ThermalInput(void)
{
  ...
  delayMs(500);              // After 500mS start conversion
  AD1CON1bits.SAMP= 0 ;      // Conver thermistor value
  while (!AD1CON1bits.DONE); // conversion done? (takes 12*Tad)
        ...
        else if (rightOpto < RIGHT_THRESHOLD)
        {
         //turn around
            ...
            get_Inputs();
                ...
                //The rightOpto is used as a back up incase middleOpto fails
                while (middleOpto > MIDDLE_THRESHOLD /*|| rightOpto > RIGHT_THRESHOLD*/)
                {
                    LATBbits.LATB14=0;
                    LATBbits.LATB15=1;
                    LATBbits.LATB12=1;
        ...
        else if (leftOpto < LEFT_THRESHOLD)
        {
         //turn around
            ...
            get_Inputs();
                ...
                //The leftOpto is used as a back up incase middleOpto fails
                while (middleOpto > MIDDLE_THRESHOLD/* || leftOpto > LEFT_THRESHOLD*/)
                {
                    LATBbits.LATB14=1;
                    LATBbits.LATB15=0;
                    LATBbits.LATB12=0;
...
/*******************************************************************************
 * Function:        void deactivate_Arm(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:        This function lowers the pale back to the ground
 *
 * Note:            None
 ******************************************************************************/
